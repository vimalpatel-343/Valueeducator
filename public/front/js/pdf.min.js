			...
			class CanvasGraphics {
				...
				setFont(t, e) {
					const i = this.commonObjs.get(t),
						n = this.current;
					if (!i) throw new Error(`Cant find font for ${t}`);
				...
				paintImageXObject(t) {
					...
					e ? this.paintInlineImageXObject(e) : (0, s.warn)("Dependent image isnt ready yet")
				}
				paintImageXObjectRepeat(t, e, i, n) {
					if (!this.contentVisible) return;
					const a = this.getObject(t);
					if (!a) {
						(0, s.warn)("Dependent image isnt ready yet");
						return
					}
					const r = a.width,
						o = a.height,
