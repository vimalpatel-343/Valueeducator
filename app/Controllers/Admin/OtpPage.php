...
class OtpPage extends BaseController
{
    ...
    {
        $data['content'] = $this->contentModel->getContentByType('otp_page');
        $data['title'] = 'UPI ID';
        
        return view('admin/otp_page/index', $data);
    }
    ...
    public function update()
    {
        ...
        $content = $this->contentModel->getContentByType('otp_page');
        ...
        return redirect()->to('/admin/upi-id')->with('success', 'UPI-ID updated successfully');
    }
}