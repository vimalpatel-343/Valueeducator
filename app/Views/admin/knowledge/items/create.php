        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Create Knowledge Item</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('admin/knowledge-centre/store-item') ?>" method="post">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="fld_category_id" required>
                                    ...
                                    <option value="<?= $category['id'] ?>"><?= $category['fld_title'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fld_video_url" value="<?= old('fld_video_url') ?>" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fld_duration" value="<?= old('fld_duration') ?>" placeholder="e.g., 10:30">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="fld_description" rows="4" required><?= old('fld_description') ?></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="fld_posted_at" value="<?= old('fld_posted_at') ?: date('Y-m-d') ?>" required>
