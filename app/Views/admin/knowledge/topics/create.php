...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Knowledge Centre / Topics /</span> Create Topic</h4>
    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url('admin/knowledge-centre/store-topic') ?>" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="mt-3">
                        <button type="submit" class="btn btn-primary me-2">Save Topic</button>
