    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?= base_url('admin/complaint-data/store') ?>" method="POST">
            <div class="form-group mb-3">
              <label for="table_heading" class="form-label">Table Heading <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="table_heading" name="table_heading" value="<?= old('table_heading') ?>" required>
            </div>
            ...
            <div class="form-group mb-3">
              ...
              <textarea class="form-control" id="table_footer" name="table_footer" rows="2"><?= old('table_footer') ?></textarea>
            </div>
